                        ...
                        <div class="py-4 sm:px-3">
                            ...
                            <div class="flex justify-center">
                                ...
                                <div class="w-40 md:w-36 lg:w-48">
                                    <label class="flex flex-col my-auto items-center px-4 py-2 mt-1 tracking-wide text-verde-silconio-800 uppercase bg-white border border-verde-silconio-600 rounded-lg shadow-lg cursor-pointer w-68 hover:bg-verde-silconio-500 hover:text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
