        ...
        <x-slot name="content">
            ...
            <div class="">
                <label class="block">
                    ...
                    <input wire:model="f_pdf" type="file" accept=".pdf" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                </label>
                @error('f_pdf')
            ...
            <div class="mt-4">
                <label class="block">
                    ...
                    <input wire:model="f_xml" type="file" accept=".xml" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                </label>
                @error('f_xml')
                <p class="mt-1 mb-1 text-xs text-red-600 italic">
                    {{ $message }}
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-1">
                        <textarea wire:model.lazy="comentarios" rows="4" name="comment" id="comment" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                    </div>
                </div>
            </div>
